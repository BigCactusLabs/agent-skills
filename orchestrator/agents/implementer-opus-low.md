---
name: implementer-opus-low
description: General implementation worker at opus/low as the frontier probe and first rung after a sonnet failure, inside a pre-provisioned git worktree. Implements, verifies with the tests named in the brief, commits on its own branch. Never pushes, merges, or deploys.
model: opus
effort: low
