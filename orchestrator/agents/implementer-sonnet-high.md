...
description: General implementation worker at sonnet/high for simple spec'd legs with a mechanical acceptance check, inside a pre-provisioned git worktree. Implements, verifies with the tests named in the brief, commits on its own branch. Never pushes, merges, or deploys.
model: sonnet
effort: high
